...
console.log(assertArraysEqual(["1", "2", "3"], ["1", "23", "3"], false));
console.log(assertArraysEqual(["1", "3"], ["1", "23", "3"], false));
console.log(assertArraysEqual(["1", "23", "3"], ["1", "23"], false));
console.log(assertArraysEqual(["1", "23"], ["1", "23", "fhqwgads"], false));